...
% we don't want to error out when creating parpool with on cluster remote
% commented out next 3 lines to facilitate remote on cluster parpool - jmurray 2022-12-02
...
procsPerNode = min(environmentProperties.NumberOfTasks*cluster.NumThreads,procsPerNode);
